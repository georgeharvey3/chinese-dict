...
class HanDict:
    ...
    def __init__(self, charset='simplified', pinyin_style='numerical'):
        ...
        engine = create_engine('sqlite:///hanlearn.db')        
    ...
    def lookup_word(self, char):
        ...
        return_d = [{'simp': res.simp,
                     'trad': res.trad,
                     'pinyin': res.pinyin,
                     'meaning': res.meaning} for res in db_all]
    ...
    def _lookup_word(self, char):
        ...
        -------
        WordResult
            WordResult object with all pinyin listed in single attribute, same for meaning.
        ...
        result = WordResult(char, simplified, traditional, pinyin, meaning, self)
